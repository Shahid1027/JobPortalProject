package com.jobPortalDesc.config;

import com.jobPortalDesc.authenticationProvider.JWTAuthenticationProvider;
import com.jobPortalDesc.filter.JWTAuthenticationFilter;
import com.jobPortalDesc.filter.JwtValidationFilter;
...
public class SecurityConfigForJWT {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http.authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/jobs/post").hasRole("COMPANY")
